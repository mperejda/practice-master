...
describe Temperature do
    ...
    describe "in degrees celsius" do
      ...
      describe "and correctly convert to fahrenheit" do
        ...
        it "at body temperature" do
          ...
          # See http://www.ruby-for bvgum.com/topic/169330
  ...
  describe "Temperature subclasses" do
    describe "Celsius subclass" do
      ...
      it "converts Fahrenheit to Celsius at a class level" do
        Celsius.new(0).ctof.class.should == Fahrenheit
        Celsius.new(0).ctof.type.should == "f"
        Celsius.new(0).ctof.temperature.should == 32
      end
    end
    ...
    describe "Fahrenheit subclass" do
      ...
      it "converts Celsius to Fahrenheit at a class level" do
        Fahrenheit.new(32).ftoc.class.should == Celsius
        Fahrenheit.new(32).ftoc.type == "c"
        Fahrenheit.new(32).ftoc.temperature == 0
      end
    end
  end
